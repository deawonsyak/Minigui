...
#define DW_ALIGNED_PAGE(obj)          (G_TYPE_CHECK_INSTANCE_CAST ((obj), DW_TYPE_ALIGNED_PAGE, DwAlignedPage))
#define DW_ALIGNED_PAGE_CLASS(klass)  (G_TYPE_CHECK_CLASS_CAST ((klass), DW_TYPE_ALIGNED_PAGE, DwAlignedPageClass))
#define DW_ALIGNED_PAGE_GET_CLASS(obj)    (G_TYPE_INSTANCE_GET_CLASS ((obj), DW_TYPE_ALIGNED_PAGE, DwAlignedPageClass))

#define DW_IS_ALIGNED_PAGE(obj)       (G_TYPE_CHECK_INSTANCE_TYPE ((obj), DW_TYPE_ALIGNED_PAGE))
