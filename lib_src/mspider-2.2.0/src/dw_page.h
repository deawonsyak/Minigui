...
#define DW_PAGE(obj)          (G_TYPE_CHECK_INSTANCE_CAST ((obj), DW_TYPE_PAGE, DwPage))

#define DW_PAGE_CLASS(klass)  (G_TYPE_CHECK_CLASS_CAST ((klass), DW_TYPE_PAGE, DwPageClass))
#define DW_PAGE_GET_CLASS(obj)    (G_TYPE_INSTANCE_GET_CLASS ((obj), DW_TYPE_PAGE, DwPageClass))

#define DW_IS_PAGE(obj)       (G_TYPE_CHECK_INSTANCE_TYPE ((obj), DW_TYPE_PAGE))
