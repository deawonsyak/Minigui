...
#define DW_TABLE(obj)          (G_TYPE_CHECK_INSTANCE_CAST ((obj), DW_TYPE_TABLE, DwTable))
#define DW_TABLE_CLASS(klass)  (G_TYPE_CHECK_CLASS_CAST ((klass), DW_TYPE_TABLE, DwTableClass))
#define DW_TABLE_GET_CLASS(obj)    (G_TYPE_INSTANCE_GET_CLASS ((obj), DW_TYPE_TABLE, DwTableClass))

#define DW_IS_TABLE(obj)       (G_TYPE_CHECK_INSTANCE_TYPE ((obj), DW_TYPE_TABLE))
...
struct _DwTable
{
   ...
   gint num_col_width_max;
	...
	/* for autofold */
   gint32 *cell_height;    // num_cell members
   gint num_cell;
   gint num_cell_max;
