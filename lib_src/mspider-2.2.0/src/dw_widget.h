...
#define DW_WIDGET(obj)          (G_TYPE_CHECK_INSTANCE_CAST ((obj), DW_TYPE_WIDGET, DwWidget))
#define DW_WIDGET_CLASS(klass)  (G_TYPE_CHECK_CLASS_CAST ((klass), DW_TYPE_WIDGET, DwWidgetClass))
#define DW_WIDGET_GET_CLASS(obj)    (G_TYPE_INSTANCE_GET_CLASS ((obj), DW_TYPE_WIDGET, DwWidgetClass))

#define DW_IS_WIDGET(obj)       (G_TYPE_CHECK_INSTANCE_TYPE ((obj), DW_TYPE_WIDGET))
...
#define  DW_WIDGET_VISIBLE(wid) IsWindowVisible(DW_WIDGET(wid)->hwnd)
#define  DW_WIDGET_VISIBLE_BY_HANDLE(hwnd) IsWindowVisible(hwnd)
...
#else
#define DW_WIDGET_WINDOW(widget) HDC_SCREEN
#endif
...
struct _DwWidget
{
   ...
   HCURSOR cursor; /* todo: move this to style */
